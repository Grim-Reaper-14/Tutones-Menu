...
namespace Tutones::Game::Native
{
    namespace
    {
        ...
        constexpr std::array<NativeDescriptor, static_cast<std::size_t>(NativeId::Count)> Descriptors{{
            ...
            // Current Enhanced target from YimMenuV2 crossmap; legacy C8B46D7727D864AA maps here.
            {0xAB078CF87FA0D018ull, "ENABLE_LASER_SIGHT_RENDERING"},
            {0xA83DA0A0DF32920Cull, "SET_PED_INFINITE_AMMO"},
            {0x53A38286A3AC16C1ull, "SET_PED_INFINITE_AMMO_CLIP"},
            ...
            {0x1D8AF8B06B2F7D3Aull, "NETWORK_EARN_FROM_PICKUP"},
            {0xA7E4AA8D29D3DAC1ull, "STOP_CUTSCENE_IMMEDIATELY"},
            {0x329FFB0BB004FDEEull, "SKIP_TO_NEXT_SCRIPTED_CONVERSATION_LINE"},
            {0xE915224DCA36212Aull, "SET_PED_SUFFERS_CRITICAL_HITS"},
            {0x8EA9C5E0178372E1ull, "CLEAR_PED_BLOOD_DAMAGE"},
            {0x5EF96FB2D3902DC7ull, "CLEAR_PED_WETNESS"},
            ...
            {0x9288ABAC1FCB4745ull, "SET_BLOCKING_OF_NON_TEMPORARY_EVENTS_FOR_AMBIENT_PEDS_THIS_FRAME"},
            {0x2DF241BBC3BB2698ull, "SET_PLAYER_HAS_RESERVE_PARACHUTE"},
            {0xFFC0556FB7074B1Full, "SET_MOBILE_PHONE_RADIO_STATE"},
            {0x048A57C4A90E9F0Dull, "SET_MOBILE_RADIO_ENABLED_DURING_GAMEPLAY"},
            {0xB41DEC3AAC1AA107ull, "GIVE_WEAPON_TO_PED"},
            {0x66B90BA528CFEBCEull, "HAS_PED_GOT_WEAPON"},
            {0xACBE463290141D49ull, "GET_MAX_AMMO"},
