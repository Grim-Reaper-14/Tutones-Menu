...
namespace Tutones::UI::V11Theme
{
    ...
    inline constexpr ImVec4 WindowBg{1.0f / 255.0f, 3.0f / 255.0f, 7.0f / 255.0f, 1.0f};
    inline constexpr ImVec4 BodyBg{4.0f / 255.0f, 7.0f / 255.0f, 12.0f / 255.0f, 1.0f};
    inline constexpr ImVec4 FooterBg{3.0f / 255.0f, 7.0f / 255.0f, 13.0f / 255.0f, 1.0f};
    inline constexpr ImVec4 RailBg{6.0f / 255.0f, 10.0f / 255.0f, 17.0f / 255.0f, 0.96f};
    inline constexpr ImVec4 PanelBg{7.0f / 255.0f, 11.0f / 255.0f, 18.0f / 255.0f, 0.98f};
    inline constexpr ImVec4 PanelBorder{2.0f / 255.0f, 108.0f / 255.0f, 249.0f / 255.0f, 0.28f};
    inline constexpr ImVec4 Separator{2.0f / 255.0f, 108.0f / 255.0f, 249.0f / 255.0f, 0.22f};
    inline constexpr ImVec4 ControlBg{10.0f / 255.0f, 16.0f / 255.0f, 25.0f / 255.0f, 1.0f};
    inline constexpr ImVec4 ControlHover{9.0f / 255.0f, 34.0f / 255.0f, 66.0f / 255.0f, 1.0f};
    ...
    // Existing feature panels use x=226..716 inside their host. Shifting the host
    // preserves those verified panel layouts while opening room for the new two-rail shell.
