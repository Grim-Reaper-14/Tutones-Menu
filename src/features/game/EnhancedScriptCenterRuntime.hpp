...
namespace Tutones::Game::EnhancedScripts
{
    ...
    inline constexpr std::array Definitions{
        ...
        Definition{"DLC.CarWash.Launcher", "Car Wash Launcher", "am_mp_carwash_launch", "am_mp_carwash_launch.c", Area::Dlc, Detail::Joaat("am_mp_carwash_launch")},
        Definition{"DLC.CarWash.Site1.Controller", "Car Wash Controller 1", "carwash1", "carwash1.c", Area::Dlc, Detail::Joaat("carwash1")},
        Definition{"DLC.CarWash.Site2.Controller", "Car Wash Controller 2", "carwash2", "carwash2.c", Area::Dlc, Detail::Joaat("carwash2")},
